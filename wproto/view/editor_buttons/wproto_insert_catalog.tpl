<p>
	<label for="wproto-catalog-title"><?php _e( 'Title', 'wproto' ); ?>: </label> <br />
	<input value="<?php echo @$data['settings']['title']; ?>" class="full-width-input" type="text" id="wproto-catalog-title" />
</p>
<p>
	<label for="wproto-catalog-numberposts"><?php _e( 'Number of posts to display', 'wproto' ); ?>: </label> <br />
	<input value="<?php echo @$data['settings']['limit'] == '' ? '7' : @$data['settings']['limit']; ?>" class="full-width-input" min="1" type="number" id="wproto-catalog-numberposts" />
</p>
<p>
	<label for="wproto-catalog-cols"><?php _e( 'Number of columns', 'wproto' ); ?>: </label> <br />
	<select class="full-width-input" id="wproto-catalog-cols">
...
<p>
	<label for="wproto-catalog-show"><?php _e( 'Display posts', 'wproto' ); ?>: </label> <br />
	<select class="full-width-input" id="wproto-catalog-show">
...
<p id="wproto-catalog-category-div" <?php echo @$data['settings']['show'] == 'category' ? '' : 'style="display: none;"'; ?>>
	<label for="wproto-catalog-category"><?php _e( 'Category', 'wproto' ); ?>: </label> <br />
	<select class="full-width-input" id="wproto-catalog-category">
		<?php
...
<p>
	<label for="wproto-catalog-orderby"><?php _e( 'Order by', 'wproto' ); ?>: </label> <br />
	<select class="full-width-input" id="wproto-catalog-orderby">
...
<p>
	<label for="wproto-catalog-sort"><?php _e( 'Sort', 'wproto' ); ?>: </label> <br />
	<select class="full-width-input" id="wproto-catalog-sort">
