...
<h2><?php _e('Hexagon carousel portfolio section', 'wproto'); ?></h2>
...
<table class="form-table wproto-form-table">
	...
	<tr>
		...
		?>
		<th><p><?php _e( 'Display portfolio items from categories', 'wproto' ); ?>:</p></th>
	...
	<tr class="wproto-display-posts-control-block" <?php echo $display_type == 'all' ? 'style="display: none;"' : ''; ?>>
		...
		<td>
			...
			<div class="wproto-posts-categories-chooser-content">
				...
				<?php
					$tax = get_terms( 'wproto_portfolio_category', array(
						'hide_empty' => 0
					));
				?>
