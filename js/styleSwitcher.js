		...
		**/
		loadFonts: function( primary_font, secondary_font ) {
			...
			if( $('#font-' + primary_font ).length == 0 ) {
				$("head").append("<link id='font-" + primary_font + "' href='https://fonts.googleapis.com/css?family=" + primary_font + ":300,400,700' rel='stylesheet' type='text/css'>");
			}
			
			if( $('#font-' + secondary_font ).length == 0 ) {
				$("head").append("<link id='font-" + secondary_font + "' href='https://fonts.googleapis.com/css?family=" + secondary_font + ":300,400,700' rel='stylesheet' type='text/css'>");
			}
