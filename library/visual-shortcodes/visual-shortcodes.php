...
class JPB_Visual_Shortcodes {
	 ...
	 */
	function styles() {
		wp_enqueue_style('jpb_visualshortcodes', WPROTO_THEME_URL . '/library/visual-shortcodes/buttons.css' );
	}
	...
	function plugins($plugins) {
		$plugins['visualshortcodes'] = WPROTO_THEME_URL . '/library/visual-shortcodes/visualshortcodes/editor_plugin.js';
		return $plugins;
	}
